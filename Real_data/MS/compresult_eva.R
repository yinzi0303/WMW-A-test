...
ntimes = 100
ntimes2 = length(result$Res$DEsingle)
...
result$rate1$zingeR = matrix(data = NA, nrow = ntimes2, ncol = ntest)
result$rate1$DEsingle = matrix(data = NA, nrow = ntimes2, ncol = ntest)
...
result$rate2$zingeR = matrix(data = NA, nrow = ntimes2, ncol = ntest)
result$rate2$DEsingle = matrix(data = NA, nrow = ntimes2, ncol = ntest)
...
result$rate3$zingeR = matrix(data = NA, nrow = ntimes2, ncol = ntest)
result$rate3$DEsingle = matrix(data = NA, nrow = ntimes2, ncol = ntest)
...
result$rate4$zingeR = matrix(data = NA, nrow = ntimes2, ncol = ntest)
result$rate4$DEsingle = matrix(data = NA, nrow = ntimes2, ncol = ntest)
...
result$auc$zingeR = matrix(data = NA, nrow = ntimes2, ncol = ntest)
result$auc$DEsingle = matrix(data = NA, nrow = ntimes2, ncol = ntest)
...
saveRDS(result,file="Real_data/MS/compresult_eva.rds")
