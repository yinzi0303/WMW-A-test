...
source("Simulation/gamma/powert/generatexy.R")
...
input_para = list(M=M, N=N, alphax=alphax, Alphay=Alphay, beta=beta, Times=Times)
Data = geneN(input_para)
saveRDS(Data, "Simulation/gamma/powert/data_gamma_ueq.rds")
# 
# 
# ##########################################################################################
