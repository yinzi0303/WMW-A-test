...
data = readRDS("data_normal_eq.rds")
re_normal_eq_comp = wresult_comp(data)
saveRDS(re_normal_eq_comp, "result_normal_eq_comp.rds")

data = readRDS("data_normal_ueq.rds")
re_normal_ueq_comp = wresult_comp(data)
saveRDS(re_normal_ueq_comp, "result_normal_ueq_comp.rds")
