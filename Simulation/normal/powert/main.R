...
re_normal_eq = wresult(data, k = 5, nperm = 1000)
saveRDS(re_normal_eq, "result_normal_eq.rds")


data = readRDS("data_normal_ueq.rds")
re_normal_ueq = wresult(data, k = 5, nperm = 1000)
saveRDS(re_normal_ueq, "result_normal_ueq.rds")
