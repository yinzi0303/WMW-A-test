...
%                 z = [gamrnd(0.5,1,[1,K(k)*5]) gamrnd(D(d),1,[1,K(k)*n])];
                z = [nbinrnd(100,0.5,[1,K(k)*5]) nbinrnd(100,D(d),[1,K(k)*n])];
...
save("result_asy_m5.mat", 'power_wmwa_asy', 'power_wmwa1', 'power_wmwa2', 'N', 'T', 'D', 'K');